...
export const projects = [
  {
    ...
    title: "NexaCommerce",
    description:
      "A full-stack e-commerce platform with real-time inventory, AI-powered recommendations, and seamless payment integration. Built for scale with microservices architecture.",
  ...
  },
  {
    ...
    title: "AuraChat",
    description:
      "Real-time messaging app with end-to-end encryption, video calls, AI chatbot integration, and beautiful animated UI. Supports 10k+ concurrent users.",
  ...
  },
  {
    ...
    description:
      "Advanced analytics dashboard with ML-powered insights, interactive 3D charts, real-time data streaming, and customizable widgets for enterprise clients.",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop",
    tech: ["React", "Three.js", "Python", "FastAPI", "TensorFlow", "D3.js"],
    github: "https://github.com",
    live: "https://example.com",
    featured: true,
    color: "#a855f7",
